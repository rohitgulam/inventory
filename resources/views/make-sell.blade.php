...
<div class="p-10 max-w-5xl mx-auto mt-16 bg-white rounded drop-shadow-2xl" >
    ...
    <form action="/purchases" method="post">
        ...
        <div class="my-4">
            <form action="/sell/order/create" method="post">
                @csrf
                @method('POST')
        ...
        <script>
            ...
            confirmOrder.addEventListener('click', (e)=> {
                ...
                if (quantity_inputJS > availableQuantity ){
                    alert(`Unajaribu kuuza bidhaa zaidi ya idadi iliyopo. Idadi iliyopo ni ${availableQuantity}. Wewe unataka kuuza ${quantity_inputJS}`)
                }else{
