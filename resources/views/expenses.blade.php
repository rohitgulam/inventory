...
<div class="pt-12">
    <div class="w-12/12 flex flex-col ">
        <div class="flex justify-between w-full my-6">
            <h2 class="text-3xl" >Orodha ya Matumizi Yote{{__('Ependiture list')}}</h2>
        ...
        <table id="datatable" class="table-auto text-left border border-collapse border-gray-400">
            <thead>
                <tr>
                    ...
                    <th class="px-6 border border-gray-400 py-2" >Jina la matumizi{{__('Expense name')}}</th>
                    <th class="px-6 border border-gray-400 py-2">Jumla{{__('total')}}</th>
                    <th class="px-6 border border-gray-400 py-2 text-center" >Siku matumizi yaliyofanyika{{__('Daily expenses')}}</th> 
                    {{-- <th class="px-6 border border-gray-400 py-2" >Bei ya moja{{__('single expense price')}}</th>
                    <th class="px-6 border border-gray-400 py-2 text-center" >Bei ya jumla{{__('total expenses')}}</th>
